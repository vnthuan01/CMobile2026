  ...
  return (
    <>
      <View className="mt-6 px-4">
        <SectionTitle
          title="Trung tâm cứu hộ"
          subtitle="Tổng quan đội và nhiệm vụ cứu hộ đang hoạt động"
        />
      </View>
        ...
        <Card colors={colors.border} bg={colors.card}>
          <View className="flex-row items-start justify-between gap-3">
            <View className="flex-1">
              ...
              >
                {team?.description ||
                  'Tham gia đội để nhận điều phối, nhiệm vụ và cập nhật cứu hộ theo thời gian thực.'}
              </Text>
            </View>
          ...
          {!!team?.contactPhone && (
            <TouchableOpacity
              onPress={() => callReporter(team.contactPhone)}
              ...
              <Card colors={colors.border} bg={colors.card}>
                <View className="flex-row items-start justify-between gap-3">
                  <View className="flex-1">
                    <Text
                      ...
                      style={{ color: colors.text }}
                    >
                      #{currentMission.sequenceOrder} ·{' '}
                      {currentMission.description || 'Nhiệm vụ cứu hộ'}
                    </Text>
                    <Text
                  ...
                  <Badge
                    label={formatMissionStatus(
                      getEffectiveStatus(currentMission),
                    )}
                    bg={colors.surface}
                ...
                <View className="mt-3 flex-row flex-wrap gap-2">
                  ...
                  <Badge
                    ...
                    bg={getPriorityPointColors(currentMission.priorityPoint).bg}
                    text={
                      getPriorityPointColors(currentMission.priorityPoint).text
                    }
                  />
                </View>
                ...
                <View className="mt-5 flex-row gap-3">
                  ...
                  <ActionButton
                    ...
                    icon="navigate"
                    onPress={() =>
                      rescueTeamService.openExternalNavigation(currentMission)
                    }
                    disabled={
                ...
                <View className="mt-3 flex-row gap-3">
                  <ActionButton
                    ...
                    icon="call"
                    onPress={() => callReporter(currentMission.reporterPhone)}
            ...
            {upcomingMissions.length > 0 ? (
                  ...
                  >
                    <View className="flex-row items-start justify-between gap-3">
                      <View className="flex-1">
                        ...
                        >
                          ...
                          {mission.description || 'Nhiệm vụ cứu hộ'}
                        </Text>
                        <Text
                          className="mt-1 text-sm"
                          style={{ color: colors.textSecondary }}
                    ...
                    <View className="mt-3 flex-row flex-wrap gap-2">
                      ...
                      <Badge
                        ...
                        bg={getPriorityPointColors(mission.priorityPoint).bg}
                        text={
              ...
              <Card colors={colors.border} bg={colors.card}>
                <Text
                  ...
                  style={{ color: colors.textSecondary }}
                >
                  Không còn nhiệm vụ nào trong hàng chờ.
                </Text>
              </Card>
            )}
          </View>
...
function ActionButton({ label, icon, onPress, primary, disabled }: any) {
  return (
    <TouchableOpacity
      ...
      style={{
        backgroundColor: primary ? '#1565C0' : '#f1f5f9',
    ...
    >
      ...
      <Text
        ...
        style={{ color: primary ? '#fff' : '#0f172a' }}
      >
        {label}
      </Text>
    </TouchableOpacity>
