...
const MOCK_REPORTS: MemberReport[] = [
  {
    ...
    statusLabel: 'Đã xong',
    content:
      'Đã kiểm tra khu vực phía Bắc. Đường đi bị chặn bởi đất đá, cần máy xúc hỗ trợ mở đường.',
    imageCount: 5,
    initials: 'NA',
  },
  {
    ...
    content:
      'Đang sơ cứu cho 2 người dân bị thương nhẹ. Cần thêm bông băng và thuốc sát trùng.',
    imageCount: 0,
    initials: 'TB',
  },
];
    ...
    <View className="flex-1" style={{ backgroundColor: colors.background }}>
      ...
      >
        <View className="w-full gap-6 p-4">
          {/* Hero Image Card */}
          <View
            className="relative h-48 overflow-hidden rounded-xl shadow-sm"
          ...
          <View className="flex-row gap-3">
            {[
              ...
              },
              {
                ...
                bgColor: `${colors.status.pending}12`,
              },
            ].map((stat, i) => (
              <View
                key={i}
                className="flex-1 items-center justify-center gap-1 rounded-lg border p-3 shadow-sm"
                style={{
                    ...
                    <View className="flex-1">
                      ...
                      {report.imageCount > 0 && (
                        <View className="mt-3 flex-row gap-2">
                          {[...Array(Math.min(3, report.imageCount))].map(
                            (_, i) => (
                              <View
                                key={i}
                                className="aspect-square flex-1 items-center justify-center overflow-hidden rounded"
                                style={{
                                  backgroundColor: isDark
                                    ? '#374151'
                                    : '#f3f4f6',
                                  opacity:
                                    i === 2 && report.imageCount > 3 ? 0.6 : 1,
                                }}
                              >
                                <Ionicons
                                  name="image"
          ...
          >
            ...
            <View className="flex-row gap-3">
              <View
                className="flex-1 flex-row items-center justify-center gap-2 rounded-lg border p-3"
                style={{
            ...
            <Text
              ...
              style={{
                color: isDark ? 'rgba(239,68,68,0.6)' : 'rgba(220,38,38,0.6)',
              }}
            >
