    ...
    <View className="flex-1" style={{ backgroundColor: colors.background }}>
      ...
      >
        ...
        <View className="gap-4 p-4">
          ...
          {/* Mission Hero Card */}
          <View
            className="h-48 items-center justify-center overflow-hidden rounded-xl shadow-md"
            style={{ backgroundColor: isDark ? '#374151' : '#d1d5db' }}
          >
            <View
              className="absolute inset-0 items-start justify-end p-4"
              style={{ backgroundColor: 'rgba(0,0,0,0.4)' }}
            >
              <View
                className="mb-2 rounded border px-2 py-1"
                style={{ backgroundColor: '#D32F2F', borderColor: '#991b1b' }}
              >
          ...
          >
            ...
            >
              <View
                ...
                style={{ width: '35%', backgroundColor: colors.secondary }}
              />
            </View>
          </View>
        </View>
        ...
        <View className="px-4 pb-4">
          <View className="mb-4 flex-row items-center justify-between">
            ...
            <TouchableOpacity className="flex-row items-center rounded px-2 py-1">
              <Ionicons
                name="filter-outline"
                size={18}
        ...
        >
          {/* Drag handle */}
          <View className="mb-4 mt-[-4px] self-center">
            <View
          ...
          <View className="gap-4">
              ...
              <View className="flex-row gap-2">
                {PRIORITY_OPTIONS.map((p) => (
                  <TouchableOpacity
                    ...
                    className="flex-1 flex-col items-center justify-center rounded-lg border p-2"
                    style={{
                      borderColor:
                        selectedPriority === p.id ? p.color : colors.border,
                      backgroundColor:
            ...
            {/* Submit */}
            <TouchableOpacity
              className="mt-2 w-full flex-row items-center justify-center rounded-lg py-3 shadow-lg"
              style={{
                backgroundColor: colors.primary,
                shadowColor: colors.primary,
                shadowOffset: { width: 0, height: 4 },
            ...
            >
              ...
              <Text className="ml-2 font-bold text-white">Tạo nhiệm vụ</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
