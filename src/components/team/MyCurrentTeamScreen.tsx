  ...
  const summaryConfig =
    teamMode === 'relief'
      ? {
          ...
          ctaLabel: isLeader ? 'Phân công' : 'Việc của tôi',
          ...
          <View className="px-4 pt-4">
            {isLeader ? (
              ...
              >
                ...
                >
                  {teamMode === 'relief'
                    ? 'Bạn đang là trưởng nhóm cứu trợ'
                    : 'Bạn đang là trưởng nhóm cứu hộ'}
                </Text>
                <Text
            ...
            <View className="mt-4 flex-row gap-3">
              ...
              >
                <Ionicons
                  name={
                    teamMode === 'relief' ? 'clipboard-outline' : 'list-outline'
                  }
                  size={18}
                  color={colors.primary}
                />
                <Text className="font-semibold" style={{ color: colors.text }}>
                  {teamMode === 'relief' ? 'Xem phân công ' : 'Xem nhiệm vụ '}
                </Text>
              </TouchableOpacity>
