...
export default function ChangePasswordScreen({
  ...
  const submitChangePassword = async () => {
    ...
    if (result.success) {
      ...
      showErrorToast('Đổi mật khẩu thất bại', result.message);
    }
      ...
      <View className="gap-2">
        ...
        <View className="relative">
          <TextInput
            ...
            className="h-14 w-full rounded-xl border px-4 pr-12 text-base"
            style={{
    ...
    <View className="flex-1" style={{ backgroundColor: colors.background }}>
      ...
      >
        ...
        <View className="px-6 pb-6 pt-8">
          ...
          >
            Vui lòng nhập mật khẩu hiện tại và mật khẩu mới bên dưới để bảo vệ
            tài khoản của bạn.
          </Text>
        </View>
              ...
              <View className="gap-2">
                {strengthChecks.map((check, i) => (
                  <View key={i} className="flex-row items-center gap-2">
                    <Ionicons
                      name={
                        check.passed ? 'checkmark-circle' : 'ellipse-outline'
                      }
                      size={16}
                      color={
                        check.passed
