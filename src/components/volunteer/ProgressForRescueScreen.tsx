...
export default function ProgressForRescueScreen({
  ...
  const [selectedStatus, setSelectedStatus] =
    useState<RescueStatusType>('in_progress');
      ...
      >
        ...
        <View className="px-4">
          ...
          >
            ...
            <View
              className="flex-1 items-center rounded-md border px-3 py-2 shadow-sm"
              style={{
            ...
            <View className="flex-row items-start gap-3">
              ...
              <View className="flex-1">
                ...
                <Text
                  ...
                  style={{ color: colors.textSecondary }}
                >
                  Nếu bạn phát hiện thêm các trường hợp cần ứng cứu khẩn cấp tại
                  khu vực này, hãy đánh dấu vị trí ngay lập tức để điều phối đội
                  cứu hộ khác.
                </Text>
                <TouchableOpacity
                  onPress={onMarkSOS}
