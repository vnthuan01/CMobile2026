...
export default function ViewTasksScreen({ onBack }: ViewTasksScreenProps = {}) {
  ...
  return (
    <View className="flex-1" style={{ backgroundColor: colors.background }}>
      <Header title="Chi tiết nhiệm vụ" onBack={onBack} center />
        ...
        <View className="p-4">
          ...
          >
            ...
            <View className="flex-row items-start gap-3 text-sm">
              ...
              />
              <Text
                className="flex-1 font-normal leading-normal"
                style={{ color: colors.text }}
              >
              ...
              <View className="flex-col gap-1">
                ...
                <View className="flex-row flex-wrap gap-2">
                  <View
                    ...
                    style={{ backgroundColor: `${colors.status.error}14` }}
                  >
                    <Ionicons
                      name="medical"
                      size={16}
                  ...
                  <View
                    className="flex-row items-center gap-1 rounded px-2 py-1"
                    style={{ backgroundColor: `${colors.status.completed}14` }}
                  >
                    <Ionicons
                      name="restaurant"
                      size={16}
        ...
        <View className="px-4 pb-4">
          <View className="flex-col gap-3">
            ...
            >
              {/* AI Route Badge */}
              <View
                className="absolute left-3 top-3 z-10 flex-row items-center gap-2 rounded-lg border px-3 py-1.5 shadow-sm backdrop-blur-sm"
                style={{
                  borderColor: `${colors.status.incoming}22`,
              ...
              <View
                ...
                style={{ backgroundColor: mapPlaceholderBg }}
              >
            ...
            <View className="grid grid-cols-2 gap-3">
              <View
                ...
                style={{
                  borderColor: `${colors.status.incoming}22`,
                  backgroundColor: `${colors.status.incoming}12`,
                }}
              >
